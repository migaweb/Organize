...
{
  public class EntityRouteAssignments
  {
    public static Dictionary<Type, string> GetEntityRouteAssignment { get; } =
    ...
    public static Dictionary<Type, string> PostEntityRouteAssignment { get; } =
      new Dictionary<Type, string>
      {
    ...
    public static Dictionary<Type, string> PutEntityRouteAssignment { get; } =
      new Dictionary<Type, string>
      {
        { typeof(TextItem), "api/items" },
        { typeof(UrlItem), "api/items" },
    ...
    public static Dictionary<Type, string> DeleteEntityRouteAssignment { get; } =
      new Dictionary<Type, string>
      {
        { typeof(TextItem), "api/items" },
        { typeof(UrlItem), "api/items" },
